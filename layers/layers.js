...
lyr_OpenStreetMap_0.setVisible(true);lyr_Dept_PDLL_1.setVisible(true);lyr_EPCI_projets_2.setVisible(true);lyr_communes_projets_3.setVisible(true);lyr_Projets_autres_4.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_Dept_PDLL_1,lyr_EPCI_projets_2,lyr_communes_projets_3,lyr_Projets_autres_4];
